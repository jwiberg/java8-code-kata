...
public class Exercise3Test extends ClassicOnlineStore {
    ...
    public void richestCustomer() {
        ...
        Optional<Integer> richestCustomer = customerList.stream().map(customer -> customer.getBudget()).max(
                comparator);
    ...
    public void youngestCustomer() {
         ...
         * Don't use {@link Stream#sorted}
         */
        Comparator<Customer> comparator = Comparator.comparingInt(customer -> customer.getAge());
